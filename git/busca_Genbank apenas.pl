...
$query = $query . " and 9000:10000[SLEN]";
...
my ($uid_list) = parse_esearchfile();				# Analisa o arquivo output_esearch.txt e armazena os Ids num array
efetchId_Genbank ($uid_list, $db);					# Baixa as sequencias e armazena no arquivo output_efetchId.txt
