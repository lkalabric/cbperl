...
use strict;
use warnings;
use lib '../lib'; # Módulo do curso contendo rotinas básicas
use CBPerl;
...
# Programa: baixaFastaGenbank.v2.0.pl
...
# Executando o comando externo clear para limpar a tela
system("clear");
